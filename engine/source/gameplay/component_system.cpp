...
ComponentSystem::ComponentSystem(System* system) noexcept : _sys{system} {
...
Scenario& ComponentSystem::scenario() noexcept { return *_sys->scenario; }
...
const Scenario& ComponentSystem::scenario() const noexcept { return *_sys->scenario; }
