...
// clang-format off
const static std::array<std::pair<FightTableIndex, std::vector<FightTableEntry>>, 20> fight_table = {
    {{1, 3, -2}, {{25, 3, 0, -3, 0.5 }, {25, 2, 0, -2, 0.25}, {25, 1, 0, -1, 0.0 }, {25, 1, 1,  0, 0.0 }}},
    {{1, 3, -1}, {{25, 3, 0, -3, 0.5 }, {25, 2, 0, -2, 0.25}, {25, 1, 1, -1, 0.0 }, {25, 1, 1,  0, 0.0 }}},
    {{1, 3,  0}, {{25, 3, 0, -2, 0.25}, {25, 2, 0, -2, 0.0 }, {25, 1, 1, -1, 0.0 }, {25, 1, 2,  1, 0.0 }}},
    {{1, 3,  1}, {{25, 3, 0, -2, 0.25}, {25, 2, 0, -1, 0.0 }, {25, 1, 1,  0, 0.0 }, {25, 1, 2,  1, 0.0 }}},
    {{1, 3,  2}, {{25, 2, 0, -2, 0.1 }, {25, 1, 0,  0, 0.0 }, {25, 1, 1,  1, 0.0 }, {25, 0, 2,  1, 0.0 }}},
    {{1, 3,  3}, {{25, 1, 0, -1, 0.1 }, {25, 1, 1,  0, 0.0 }, {25, 1, 1,  1, 0.0 }, {25, 0, 2,  2, 0.1 }}},
    {{1, 3,  4}, {{25, 1, 0, -1, 0.1 }, {25, 1, 2,  0, 0.0 }, {25, 1, 3,  1, 0.1 }, {25, 0, 2,  2, 0.25}}},
    {{1, 3,  5}, {{25, 1, 1, -1, 0.0 }, {25, 1, 2,  1, 0.0 }, {25, 1, 3,  2, 0.1 }, {25, 0, 3,  3, 0.25}}},
    {{1, 3,  6}, {{25, 1, 1, -1, 0.0 }, {25, 1, 2,  2, 0.0 }, {25, 1, 3,  3, 0.25}, {25, 0, 3,  3, 0.5 }}},
    {{1, 3,  7}, {{25, 1, 2,  0, 0.0 }, {25, 1, 2,  2, 0.1 }, {25, 0, 3,  3, 0.5 }, {25, 0, 3,  3, 0.75}}},
    
    {{4, 6, -2}, {{25, 4, 0, -3, 0.5 }, {25, 3, 0, -2, 0.25}, {25, 2, 0, -1, 0.0 }, {25, 2, 1,  0, 0.0 }}},
    {{4, 6, -1}, {{25, 4, 0, -3, 0.5 }, {25, 3, 0, -2, 0.25}, {25, 2, 1, -1, 0.0 }, {25, 2, 2,  0, 0.0 }}},
    {{4, 6,  0}, {{25, 4, 0, -2, 0.25}, {25, 3, 0, -2, 0.0 }, {25, 2, 1, -1, 0.0 }, {25, 2, 2,  1, 0.0 }}},
    {{4, 6,  1}, {{25, 4, 0, -2, 0.25}, {25, 3, 1, -1, 0.0 }, {25, 2, 2,  0, 0.0 }, {25, 2, 3,  1, 0.0 }}},
    {{4, 6,  2}, {{25, 4, 0, -2, 0.1 }, {25, 2, 1,  0, 0.0 }, {25, 2, 2,  1, 0.0 }, {25, 1, 3,  1, 0.0 }}},
    {{4, 6,  3}, {{25, 2, 0, -1, 0.1 }, {25, 2, 2,  0, 0.0 }, {25, 2, 2,  1, 0.0 }, {25, 0, 3,  2, 0.1 }}},
    {{4, 6,  4}, {{25, 2, 0, -1, 0.1 }, {25, 2, 2,  0, 0.0 }, {25, 2, 3,  1, 0.1 }, {25, 0, 3,  2, 0.25}}},
    {{4, 6,  5}, {{25, 2, 2, -1, 0.0 }, {25, 2, 3,  1, 0.0 }, {25, 1, 4,  2, 0.1 }, {25, 0, 4,  3, 0.25}}},
    {{4, 6,  6}, {{25, 2, 2, -1, 0.0 }, {25, 1, 3,  2, 0.0 }, {25, 1, 4,  3, 0.25}, {25, 0, 4,  3, 0.5 }}},
    {{4, 6,  7}, {{25, 2, 3,  0, 0.0 }, {25, 1, 3,  2, 0.1 }, {25, 0, 4,  3, 0.5 }, {25, 0, 4,  3, 0.75}}}
    };
// clang-format on
